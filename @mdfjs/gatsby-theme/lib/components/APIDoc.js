...
const markdown_module_less_1 = __importDefault(
  require('../templates/markdown.module.less'),
);
...
const APIDoc = ({
  ...
  react_1.useEffect(() => {
    var _a, _b, _c;
    if (
      !(exampleSections === null || exampleSections === void 0
        ? void 0
        : exampleSections.API)
    ) {
      updateActive('design');
    ...
    const initData = createApiStructure(
      (_b =
        (_a =
          exampleSections === null || exampleSections === void 0
            ? void 0
            : exampleSections.API) === null || _a === void 0
          ? void 0
    ...
    const defaultKey =
      (_c = initData[0]) === null || _c === void 0 ? void 0 : _c.title;
  ...
  const genExtra = (options) =>
    react_1.default.createElement(
      ...
      null,
      (options === null || options === void 0 ? void 0 : options.require) &&
        react_1.default.createElement(
          'span',
          { className: APIDoc_module_less_1.default.require },
          options === null || options === void 0 ? void 0 : options.require,
        ),
      (options === null || options === void 0 ? void 0 : options.type) &&
        react_1.default.createElement(
          'span',
          { className: APIDoc_module_less_1.default.type },
          options === null || options === void 0 ? void 0 : options.type,
        ),
      (options === null || options === void 0 ? void 0 : options.default) &&
        react_1.default.createElement(
          'span',
          { className: APIDoc_module_less_1.default.default },
          options === null || options === void 0 ? void 0 : options.default,
        ),
    );
  const empty = react_1.default.createElement(
    'div',
    { className: APIDoc_module_less_1.default.emptyContainer },
    react_1.default.createElement(
      'div',
      { className: APIDoc_module_less_1.default.empty },
      react_1.default.createElement(icons_1.default, {
        component: empty_svg_1.default,
      }),
  ...
  const renderCollapse = () => {
    return react_1.default.createElement(
      ...
      {
        id: 'apiStructure',
        className: markdown_module_less_1.default.markdown,
      },
      react_1.default.createElement(
        antd_1.Collapse,
        {
          className: APIDoc_module_less_1.default.rootCollapse,
        ...
        collapseData.map((data, i) => {
          ...
          return react_1.default.createElement(
            Panel,
            {
              ...
              header: data.title,
              className: data.show
                ? APIDoc_module_less_1.default.rootItem
                : APIDoc_module_less_1.default.hidden,
            },
            data.content &&
            ...
            (_a = data === null || data === void 0 ? void 0 : data.children) ===
              null || _a === void 0
              ? void 0
              : _a.map((child, index) =>
                  react_1.default.createElement(
  ...
  return react_1.default.createElement(
    'div',
    { className: APIDoc_module_less_1.default.docPane },
    ...
    !exampleSections
      ? react_1.default.createElement(antd_1.Skeleton, {
          className: APIDoc_module_less_1.default.skeleton,
          paragraph: { rows: 16 },
        })
      : react_1.default.createElement(
          'div',
          { className: APIDoc_module_less_1.default.docContent },
          active === 'API' && collapseData.length > 0 && renderCollapse(),
          collapseData.length <= 0 && active === 'API' && empty,
          active === 'design'
            ? react_1.default.createElement(
                'div',
                { className: APIDoc_module_less_1.default.designContent },
                react_1.default.createElement('div', {
                  /* eslint-disable-next-line react/no-danger */
                  dangerouslySetInnerHTML: {
                    __html: description,
                    ...
                    __html:
                      (_b =
                        (_a =
                          exampleSections === null || exampleSections === void 0
                            ? void 0
                            : exampleSections.design) === null || _a === void 0
                          ? void 0
                          : _a.node) === null || _b === void 0
                        ? void 0
                        : _b.html,
                ...
                !((_d =
                  (_c =
                    exampleSections === null || exampleSections === void 0
                      ? void 0
                      : exampleSections.design) === null || _c === void 0
                    ? void 0
