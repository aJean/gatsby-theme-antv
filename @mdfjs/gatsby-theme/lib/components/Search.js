...
const Search = ({ docsearchOptions }) => {
  ...
  react_1.useEffect(() => {
    if (typeof window !== 'undefined') {
      Promise.resolve()
        .then(() => __importStar(require('docsearch.js')))
  ...
  return react_1.default.createElement(
    'label',
    { className: Search_module_less_1.default.search, htmlFor: 'search' },
    react_1.default.createElement(icons_1.SearchOutlined, {
      className: Search_module_less_1.default.icon,
    }),
    react_1.default.createElement('input', {
      className: Search_module_less_1.default.input,
      id: 'search',
      placeholder: t('搜索…'),
    }),
  );
