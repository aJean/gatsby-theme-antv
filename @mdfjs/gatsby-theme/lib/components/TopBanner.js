...
const TopBanner_module_less_1 = __importDefault(
  require('./TopBanner.module.less'),
);
...
const TopBanner = ({ announcement }) => {
  ...
  return content
    ? react_1.default.createElement(Announcement_1.default, {
        message: react_1.default.createElement(
          'span',
          { className: TopBanner_module_less_1.default.topBannerAnnouncements },
          content,
        ),
        bannerId: bannerId,
