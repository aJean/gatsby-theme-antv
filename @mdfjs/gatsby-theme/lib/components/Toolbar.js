...
const Toolbar = ({ sourceCode, fileExtension, playground = {}, location, title = '', isFullScreen = false, editorTabs, currentEditorTab, onEditorTabChange, onToggleFullscreen = null, onExecuteCode, }) => {
    ...
    return (react_1.default.createElement("div", { className: Toolbar_module_less_1.default.toolbar },
        react_1.default.createElement("div", { className: Toolbar_module_less_1.default.editortabs }, editorTabs.map((tab, index) => (react_1.default.createElement("span", { key: index, className: tab === currentEditorTab ? Toolbar_module_less_1.default.current : '', onClick: () => onEditorTabChange(tab) }, tab)))),
        ...
        react_1.default.createElement(Paragraph, { copyable: { text: sourceCode }, style: { marginLeft: 6 } }),
        playground.htmlCodeTemplate && (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement(antd_1.Modal, { visible: htmlModalVisible, title: t('HTML 代码'), onCancel: () => updateHtmlModalVisible(false), width: "60vw", footer: react_1.default.createElement(antd_1.Button, { onClick: () => updateHtmlModalVisible(false) }, t('取消')) },
                react_1.default.createElement("div", { className: Toolbar_module_less_1.default.editor },
                    react_1.default.createElement(react_1.Suspense, { fallback: react_1.default.createElement(PageLoading_1.default, null) },
                        react_1.default.createElement(MonacoEditor, { height: "600px", language: "html", value: getHtmlCodeTemplate(), options: {
                                readOnly: true,
