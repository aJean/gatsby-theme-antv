...
const Banner = ({
  ...
  const showVideo = () => {
    ...
    antd_1.Modal.info({
      ...
      content: react_1.default.createElement(video_react_1.Player, {
        className: Banner_module_less_1.default.video,
        autoPlay: true,
        src: video,
      }),
      width: '70%',
    ...
    return react_1.default.createElement(
      ButtonLink,
      {
        ...
        className: classnames_1.default(
          Banner_module_less_1.default.buttonLink,
          Banner_module_less_1.default[button.type || ''],
      ...
      react_1.default.createElement(
        'span',
        { className: Banner_module_less_1.default.button },
        button.text,
      ),
    );
  });
    ...
    renderButtons.push(
      react_1.default.createElement(
        'div',
        {
          key: 'video',
          onClick: showVideo,
          className: Banner_module_less_1.default.videoButtonWrapper,
        },
        react_1.default.createElement(
          'div',
          { className: Banner_module_less_1.default.videoButton },
          react_1.default.createElement(icons_1.CaretRightOutlined, {
            className: Banner_module_less_1.default.videoButtonIcon,
          }),
          react_1.default.createElement(
            'p',
            {
              className: Banner_module_less_1.default.videoButtonText,
              style: {
                fontSize: '14px',
                lineHeight: '40px',
              },
    ...
    if (githubObj && githubObj.owner && githubObj.name) {
      renderButtons.push(
        react_1.default.createElement(
          ...
          {
            key: 'github',
            className: Banner_module_less_1.default.githubWrapper,
          },
          react_1.default.createElement(react_github_button_1.default, {
            type: 'stargazers',
            size: 'large',
  ...
  return react_1.default.createElement(
    ...
    {
      className: classnames_1.default(
        Banner_module_less_1.default.wrapper,
        className,
      ),
      style: style,
    },
    react_1.default.createElement(
      'div',
      { className: Banner_module_less_1.default.content },
      react_1.default.createElement(
        'div',
        { className: Banner_module_less_1.default.text },
        react_1.default.createElement(
          'div',
          {
            className: classnames_1.default(
              Banner_module_less_1.default.title,
              'banner-title',
            ),
          },
          title,
        ...
        react_1.default.createElement(
          ...
          {
            className: classnames_1.default(
              Banner_module_less_1.default.description,
              'banner-description',
            ),
          },
          description,
        ...
        react_1.default.createElement(
          ...
          {
            className: classnames_1.default(
              Banner_module_less_1.default.buttons,
              'banner-buttons',
            ),
          },
          renderButtons,
      ...
      react_1.default.createElement(
        ...
        {
          className: classnames_1.default(
            Banner_module_less_1.default.notifications,
            'notifications',
          ),
        },
        notificationsNode,
      ...
      react_1.default.createElement(
        ...
        {
          className: classnames_1.default(
            Banner_module_less_1.default.teaser,
            'teaser',
          ),
        },
        react_1.default.createElement(
          ...
          {
            className: classnames_1.default(
              Banner_module_less_1.default.teaserimg,
              'teaser-img',
            ),
          },
          coverImage,
      ...
      react_1.default.createElement('img', {
        className: Banner_module_less_1.default.backLeftBottom,
        src: backLeftBottom,
        alt: 'back',
      }),
    ),
