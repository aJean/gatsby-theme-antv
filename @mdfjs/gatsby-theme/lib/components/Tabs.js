...
const Tabs = ({
      ...
      return {
        ...
        label: react_1.default.createElement(
          ...
          react_1.default.createElement(
            'span',
            { className: Tabs_module_less_1.default.result },
            item[0],
          ),
          react_1.default.createElement(
            'span',
            { className: Tabs_module_less_1.default.resultNum },
            item[1].length,
          ),
        ),
      };
  ...
  const hiddenTitleForDocsearch = react_1.default.createElement(
    'span',
    { className: Tabs_module_less_1.default.hidden },
    title,
    ' - ',
  );
  const empty = react_1.default.createElement(antd_1.Empty, {
  ...
  return react_1.default.createElement(
    'div',
    { className: Tabs_module_less_1.default.tabsBar },
    react_1.default.createElement(
      'ul',
      { className: Tabs_module_less_1.default.tabs },
      react_1.default.createElement(
        'li',
        {
    ...
    active === 'API' &&
      ...
      react_1.default.createElement(
        'div',
        { className: Tabs_module_less_1.default.tabExtra },
        react_1.default.createElement(
          'div',
          { className: Tabs_module_less_1.default.tabSearch },
          react_1.default.createElement(
            antd_1.AutoComplete,
            {
              className: Tabs_module_less_1.default.autoComplete,
              options: options,
              value: input,
              onSelect: onSelect,
              allowClear: true,
            ...
            react_1.default.createElement(antd_1.Input, {
              size: 'small',
              prefix: react_1.default.createElement(
                icons_1.SearchOutlined,
                null,
              ),
              className: Tabs_module_less_1.default.input,
              placeholder: t('搜索'),
        ...
        react_1.default.createElement(
          'div',
          {
            className: Tabs_module_less_1.default.collapseAll,
            onClick: collaspseALL,
          },
