...
const Colors = ({ colorStyle = {}, colors = [], names = [], name, description, }) => {
    if (colors.length === 0) {
        return null;
    }
    return (react_1.default.createElement("div", { className: Swatch_module_less_1.default.colors, style: { width: colors.length > 10 ? '100%' : '' } },
        react_1.default.createElement("div", { className: Swatch_module_less_1.default.container },
            description ? (react_1.default.createElement("div", { className: Swatch_module_less_1.default.name },
                react_1.default.createElement("span", { style: { marginRight: '5px' } }, name),
                react_1.default.createElement(antd_1.Tooltip, { placement: "bottom", title: description },
                    react_1.default.createElement(icons_1.QuestionCircleFilled, null)))) : (react_1.default.createElement("span", { className: Swatch_module_less_1.default.name }, name)),
...
const Swatch = ({ title, darkmode = true, colors = '', colornames = '', descriptions = '', grid, }) => {
        ...
        react_1.default.createElement("div", { className: Swatch_module_less_1.default.panel },
            react_1.default.createElement("div", { className: Swatch_module_less_1.default.panelContainer },
                colorsSwatchArray.map((swatch, i) => (react_1.default.createElement(Colors, { key: i, name: colorNamesArray[i], colorStyle: {
                    ...
                    }, colors: swatch, description: des[i] }))),
