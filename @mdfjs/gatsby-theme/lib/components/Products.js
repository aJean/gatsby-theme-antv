...
const Products = ({ show, rootDomain = '', language, className }) => {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      'div',
      {
        className: classnames_1.default(
          Product_module_less_1.default.products,
          className,
          {
      ...
      react_1.default.createElement(
        'div',
        { className: Product_module_less_1.default.container },
        ...
        react_1.default.createElement(
          ...
          data
            ...
            .map((product) =>
              react_1.default.createElement(Product_1.default, {
                key: product.title,
                name: product.title,
    ...
    react_1.default.createElement('div', {
      className: Product_module_less_1.default.mask,
    }),
  );
};
