...
const PlayGround = ({ source, babeledSource, relativePath = '', playground = {}, location, title = '', height, replaceId = 'container', }) => {
    ...
    const splitPaneSize = lodash_es_1.get(site.siteMetadata, ['mdPlayground', 'splitPaneMainSize'], '62%');
...
insertCss(`;
    ...
    return (react_1.default.createElement("div", { className: MdPlayGround_module_less_1.default.playground, ref: fullscreenNode, style: height ? { height } : {} },
        react_1.default.createElement(react_split_pane_1.default, { split: isWide ? 'vertical' : 'horizontal', defaultSize: splitPaneSize, minSize: 100, onDragFinished: dispatchResizeEvent },
            ...
            react_1.default.createElement("div", { className: MdPlayGround_module_less_1.default.editor },
                ...
                react_1.default.createElement("div", { className: MdPlayGround_module_less_1.default.monaco, 
                    // toolbar height = 36px
                    style: { height: 'calc(100% - 36px)' } }, editor)))));
};
