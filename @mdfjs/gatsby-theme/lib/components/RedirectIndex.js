    ...
    constructor(args) {
        ...
        this.renderIndex = (data) => {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(Seo_1.default, { title: title || 'AntV', titleSuffix: t('蚂蚁数据可视化'), description: t('AntV 是蚂蚁集团全新一代数据可视化解决方案，致力于提供一套简单方便、专业可靠、无限可能的数据可视化最佳实践。'), lang: this.langKey }),
