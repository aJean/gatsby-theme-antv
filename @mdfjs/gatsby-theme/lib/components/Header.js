...
const redirectToChinaMirror = (githubUrl) => {
    ...
    if (!name.includes('.') && !name.includes('-')) {
        switch (name) {
            case 'antvis':
                window.location.href = window.location.href.replace(window.location.host, `antv.gitee.io`);
                break;
            default:
...
const Header = ({ subTitle = '', subTitleHref, pathPrefix = '', path = '', navs = [], showSearch = true, showGithubStar = false, showGithubCorner = true, showAntVProductsCard = true, showLanguageSwitcher = true, showChinaMirror = true, logo, onLanguageChange, siteUrl, githubUrl = 'https://github.com/antvis', defaultLanguage, Link = 'a', transparent, isHomePage, isAntVSite = false, rootDomain = '', docsearchOptions, versions, ecosystems, }) => {
    ...
    const { img, link } = {
        img: isAntVHome ? react_1.default.createElement(antvhome_svg_1.default, null) : react_1.default.createElement(antv_svg_1.default, null),
        link: '',
        ...logo,
    };
    react_1.useEffect(() => {
    ...
    let chinaMirrorUrl = '';
    if (name === 'antvis')
        chinaMirrorUrl = `https://antv.gitee.io`;
    ...
    const menu = (react_1.default.createElement("ul", { className: classnames_1.default(Header_module_less_1.default.menu, {
        ...
        ecosystems && ecosystems.length ? (react_1.default.createElement("li", null,
            react_1.default.createElement(antd_1.Dropdown, { className: Header_module_less_1.default.ecoSystems, overlay: react_1.default.createElement(antd_1.Menu, null, lodash_es_1.map(ecosystems, ({ url, name: ecosystemName }) => (react_1.default.createElement(antd_1.Menu.Item, { key: ecosystemName === null || ecosystemName === void 0 ? void 0 : ecosystemName[lang] },
                    react_1.default.createElement("a", { target: "_blank", rel: "noreferrer", href: url }, ecosystemName === null || ecosystemName === void 0 ? void 0 :
                        ecosystemName[lang],
                        " ",
                        react_1.default.createElement(ExternalLinkIcon_1.default, null)))))) },
                react_1.default.createElement("span", null,
                    t('周边生态'),
                    react_1.default.createElement(icons_1.DownOutlined, { style: { marginLeft: '6px' } }))))) : null,
        showChinaMirror && isWide ? (react_1.default.createElement(antd_1.Popover, { title: null, content: react_1.default.createElement("div", { style: { width: 300 } },
                react_1.default.createElement("div", null,
                    react_1.default.createElement("span", { role: "img", "aria-labelledby": "\u4E2D\u56FD", style: { marginRight: '8px' } }, "\uD83C\uDDE8\uD83C\uDDF3"),
            ...
            react_1.default.createElement("li", { style: { display: logoLink.includes('gitee') ? 'none' : '' } },
                react_1.default.createElement("a", { href: chinaMirrorUrl, onClick: (e) => {
                    ...
                    t('国内镜像'),
                    !isAntVHome && react_1.default.createElement(ExternalLinkIcon_1.default, null))))) : null,
        showChinaMirror && !isWide && !logoLink.includes('gitee') && (react_1.default.createElement(antd_1.Modal, { visible: chinaMirrorHintVisible, cancelText: "\u4E0D\u518D\u63D0\u9192", okText: "\u7ACB\u5373\u524D\u5F80", onCancel: () => {
                updateChinaMirrorHintVisible(false);
            }, onOk: () => exports.redirectToChinaMirror(githubUrl), cancelButtonProps: {
                onClick: () => {
                    localStorage.setItem('china-mirror-no-more-hint', Date.now().toString());
                    updateChinaMirrorHintVisible(false);
                },
            } },
            react_1.default.createElement("div", { className: Header_module_less_1.default.modalContent },
        ...
        showAntVProductsCard ? (react_1.default.createElement("li", { ...productItemProps },
            react_1.default.createElement("a", null,
                t('所有产品'),
                !isAntVHome ? (react_1.default.createElement("img", { src: "https://gw.alipayobjects.com/zos/antfincdn/FLrTNDvlna/antv.png", alt: "antv logo arrow", className: classnames_1.default(Header_module_less_1.default.arrow, {
                        [Header_module_less_1.default.open]: productMenuVisible,
                    }) })) : (react_1.default.createElement(icons_1.CaretDownFilled, { style: { top: '1px', color: '#fff' }, className: classnames_1.default(Header_module_less_1.default.arrow, {
                        [Header_module_less_1.default.open]: productMenuVisible,
                    }) }))),
        ...
        showLanguageSwitcher && (react_1.default.createElement("li", null,
            react_1.default.createElement(antd_1.Dropdown, { placement: "bottomRight", overlay: react_1.default.createElement(antd_1.Menu, { defaultSelectedKeys: [lang], selectable: true, onSelect: ({ key }) => {
                ...
                react_1.default.createElement("a", { className: "ant-dropdown-link", onClick: (e) => e.preventDefault() },
                    react_1.default.createElement(translation_svg_1.default, { className: Header_module_less_1.default.translation }))))),
        showGithubCorner && (react_1.default.createElement("li", { className: Header_module_less_1.default.githubCorner },
            react_1.default.createElement("a", { href: git_url_parse_1.default(githubUrl).toString('https'), target: "_blank", rel: "noopener noreferrer" },
                react_1.default.createElement(icons_1.GithubOutlined, null)))),
        showGithubStar && (react_1.default.createElement("li", { className: Header_module_less_1.default.githubStar },
            react_1.default.createElement("span", null,
                react_1.default.createElement(react_github_btn_1.default, { href: `https://github.com/${git_url_parse_1.default(githubUrl).full_name}`, "data-size": "large", "data-show-count": "true", "aria-label": `Star ${git_url_parse_1.default(githubUrl).full_name} on GitHub` }, "Star"))))));
    return (react_1.default.createElement("header", { className: classnames_1.default(Header_module_less_1.default.header, {
            ...
            [Header_module_less_1.default.lightTheme]: !!isAntVHome && !productMenuVisible && isWide,
        ...
        react_1.default.createElement("div", { className: Header_module_less_1.default.container },
            react_1.default.createElement("div", { className: Header_module_less_1.default.left },
                ...
                showSearch && !isAntVHome && (react_1.default.createElement(Search_1.default, { docsearchOptions: docsearchOptions }))),
