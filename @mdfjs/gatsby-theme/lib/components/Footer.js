...
const Footer = ({ columns, bottom, theme = 'dark', language, rootDomain = '', location, ...restProps }) => {
    ...
    return (react_1.default.createElement(rc_footer_1.default, { maxColumnsPerRow: 5, theme: theme, columns: columns || [], className: classnames_1.default(Footer_module_less_1.default.footer, {
            ...
            react_1.default.createElement("div", { className: Footer_module_less_1.default.bottom },
                react_1.default.createElement("div", null,
                    react_1.default.createElement("a", { href: "https://online.ai101test.com", target: "_blank", rel: "noopener noreferrer" },
                        react_1.default.createElement(icons_1.WeiboOutlined, null)),
                    react_1.default.createElement("a", { href: "https://online.ai101test.com", target: "_blank", rel: "noopener noreferrer" },
                        react_1.default.createElement(icons_1.ZhihuOutlined, null)),
                    react_1.default.createElement("a", { href: "https://git.100tal.com/jituan_101_web/101console", target: "_blank", rel: "noopener noreferrer" },
                        react_1.default.createElement(icons_1.GithubOutlined, null)),
                    react_1.default.createElement("a", { href: "https://online.ai101test.com" }, t('关于我们')),
                    react_1.default.createElement("a", { href: "https://fe.ai101test.com", target: "_blank", rel: "noopener noreferrer" }, t('测试地址'))),
                react_1.default.createElement("div", null,
                    "\u00A9 ",
                    new Date().getFullYear(),
                    " Made with \u2764 by",
                    ' ',
                    react_1.default.createElement("a", { href: "https://github.com/aJean" }, "qy"))))), ...omit_js_1.default(restProps, ['githubUrl']) }));
};
