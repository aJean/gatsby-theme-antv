...
const PlayGround_module_less_1 = __importDefault(
  require('./PlayGround.module.less'),
);
...
const PlayGround = ({
  ...
  react_1.useEffect(() => {
    ...
    if (!pathname) return;
    updateDocsEmpty(
      !((_a = design === null || design === void 0 ? void 0 : design.node) ===
        null || _a === void 0
        ? void 0
        : _a.html) &&
        !description &&
        !((_b = API === null || API === void 0 ? void 0 : API.node) === null ||
        _b === void 0
          ? void 0
          : _b.html),
    );
...
insertCss(`;
  ...
  const updateCurrentExampleParams = (current) => {
    if (
      !(current === null || current === void 0 ? void 0 : current.relativePath)
    )
      return;
    updateRelativePath(
      current === null || current === void 0 ? void 0 : current.relativePath,
  ...
  react_1.useEffect(() => {
    ...
    for (let i = 0; i < examples.length; i += 1) {
      ...
      const fullname = `${dirname}/demo/${
        (_a = location.hash) === null || _a === void 0
          ? void 0
          : _a.replace('#', '')
      }`;
  ...
  const executeCode = () => {
    ...
    execute(
      compiledCode,
      playgroundNode.current,
      playground === null || playground === void 0
        ? void 0
  ...
  react_1.useEffect(() => {
    ...
    return () => {
      if (
        playground === null || playground === void 0
          ? void 0
          : playground.playgroundWillUnmount
      ) {
        // eslint-disable-next-line no-new-func
        new Function(
          playground === null || playground === void 0
  ...
  const codeEditor = react_1.default.createElement(MonacoEditor, {
  ...
  react_1.useEffect(() => {
    ...
    if (
      !currentExample ||
      !(currentExample === null || currentExample === void 0
        ? void 0
    ...
    const id = `example-${
      (_a =
        currentExample === null || currentExample === void 0
          ? void 0
          : currentExample.filename) === null || _a === void 0
        ? void 0
        : _a.split('.')[0]
    }`;
  ...
  react_1.useEffect(() => {
    ...
    if (
      render &&
      (render === null || render === void 0 ? void 0 : render.length) > 0
    ) {
  ...
  const transforNode = (data, result) =>
    data.map((item) => {
      ...
      return {
        ...frontmatter,
        value: `secondaryKey-${
          fields === null || fields === void 0 ? void 0 : fields.slug
        }`,
        children:
          (_a = result.find(({ title: k }) => k === frontmatter.title)) ===
            null || _a === void 0
            ? void 0
            : _a.children,
      };
  ...
  const getTreeData = () => {
        ...
        const child = {
          ...
          title:
            typeof item.title === 'object'
              ...
              : item.title ||
                (item === null || item === void 0 ? void 0 : item.filename),
          value: path,
        };
    ...
    treeData.forEach((treeItem) => {
      var _a;
      const slugPieces =
        (_a = treeItem.value) === null || _a === void 0
          ? void 0
          : _a.split('/');
  ...
  return playground && currentExample && layout
    ? react_1.default.createElement(
        ...
        {
          split: layoutConfig_1.splitPaneMap[layout].outside.split,
          size: layoutConfig_1.splitPaneMap[layout].outside.size,
        ...
        react_1.default.createElement(
          react_split_pane_1.default,
          {
            split: layoutConfig_1.splitPaneMap[layout].inside.split,
            size: layoutConfig_1.splitPaneMap[layout].inside.size,
            onDragFinished: dispatchResizeEvent,
            className: PlayGround_module_less_1.default.playground,
            ref: (e) => {
          ...
          react_1.default.createElement(
            antd_1.Layout,
            { className: PlayGround_module_less_1.default.playgroundCard },
            react_1.default.createElement(
              Sider,
              {
                collapsedWidth: 0,
                ...
                collapsible: true,
                collapsed: collapsed,
                className: PlayGround_module_less_1.default.menuSider,
                theme: 'light',
              },
              react_1.default.createElement(PlayGrounds_1.default, {
                getPath: getPath,
            ...
            react_1.default.createElement(icons_1.LeftOutlined, {
              className: PlayGround_module_less_1.default.trigger,
            ...
            relativePath
              ? react_1.default.createElement(
                  antd_1.Layout,
                  null,
                  react_1.default.createElement(antd_1.PageHeader, {
                    ghost: false,
                    title:
                    ...
                    subTitle: react_1.default.createElement(
                      ...
                      react_1.default.createElement(
                        'a',
                        {
                          href: document_1.getGithubSourceUrl({
                            githubUrl,
                            relativePath,
                            prefix: 'examples',
                          }),
                          ...
                          className:
                            PlayGround_module_less_1.default.editOnGtiHubButton,
                        },
                        react_1.default.createElement(
                    ...
                    extra: react_1.default.createElement(
                      antd_1.Space,
                      {
                      ...
                      themeSwitcher &&
                        react_1.default.createElement(ThemeSwitcher_1.default, {
                  ...
                  react_1.default.createElement(
                    ...
                    {
                      className:
                        PlayGround_module_less_1.default.chartContainer,
                    },
                    react_1.default.createElement(
                      'div',
                      {
                        className: classnames_1.default(
                          PlayGround_module_less_1.default.preview,
                      ...
                      error
                        ...
                        : react_1.default.createElement('div', {
                            ref: playgroundNode,
                            className: PlayGround_module_less_1.default[view],
                          }),
                    ),
                  ),
                )
              : react_1.default.createElement(antd_1.Skeleton, {
                  paragraph: { rows: 8 },
                  className: PlayGround_module_less_1.default.skeleton,
                }),
          ),
          react_1.default.createElement(
            'div',
            { className: PlayGround_module_less_1.default.editor },
            title &&
              fileExtension &&
            ...
            !relativePath
              ...
              : react_1.default.createElement(
                  'div',
                  { className: PlayGround_module_less_1.default.monaco },
                  react_1.default.createElement(
                    react_1.Suspense,
                    {
        ...
        relativePath && (layout === 'viewDefault' || layout === 'viewThreeCols')
          ? react_1.default.createElement(APIDoc_1.default, {
              markdownRemark: markdownRemark,
              githubUrl: githubUrl,
              relativePath: relativePath,
              exampleSections: { ...exampleSections, design, API },
