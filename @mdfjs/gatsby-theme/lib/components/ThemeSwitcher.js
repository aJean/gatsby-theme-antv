...
const ThemeSwitcher_module_less_1 = __importDefault(
  require('./ThemeSwitcher.module.less'),
);
...
const Colors = ({ colorStyle = {}, colors = [] }) => {
  ...
  return react_1.default.createElement(
    'div',
    { className: ThemeSwitcher_module_less_1.default.colors },
    colors.map((color, i) =>
      react_1.default.createElement('div', {
        className: ThemeSwitcher_module_less_1.default.color,
        style: {
          ...colorStyle,
...
const ThemeSwitcher = ({ updateTheme }) => {
  ...
  const defaultColorArr =
    (_a = pallette_json_1.default.categorical[0].colors20) === null ||
    _a === void 0
      ? void 0
      : _a.slice(0, 3);
  ...
  const menu = react_1.default.createElement(
    antd_1.Menu,
    { className: ThemeSwitcher_module_less_1.default.operateBtns },
    react_1.default.createElement(
      antd_1.Menu.ItemGroup,
      { title: t('分类色板') },
      pallette_json_1.default.categorical.map((color, key) => {
        return react_1.default.createElement(
          antd_1.Menu.Item,
          { key: key },
          react_1.default.createElement(
            'div',
            {
              className: ThemeSwitcher_module_less_1.default.panelContainer,
              onClick: () => {
            ...
            react_1.default.createElement(Colors, {
              colorStyle: {
          ...
          react_1.default.createElement(
            antd_1.Space,
            { className: ThemeSwitcher_module_less_1.default.btnGroup },
            react_1.default.createElement(icons_1.VerticalAlignBottomOutlined, {
              onClick: () => updateCurPalette(color.colors20),
            }),
            react_1.default.createElement(icons_1.CopyOutlined, {
              onClick: () => {
    ...
    react_1.default.createElement(
      antd_1.Menu.ItemGroup,
      { title: t('顺序色板') },
      pallette_json_1.default.continuous.map((color, key) => {
        return react_1.default.createElement(
          antd_1.Menu.Item,
          { key: key },
          react_1.default.createElement(
    ...
    react_1.default.createElement(
      antd_1.Menu.ItemGroup,
      { title: t('发散色板') },
      pallette_json_1.default.discrete.map((color, key) => {
        return react_1.default.createElement(
          antd_1.Menu.Item,
          { key: key },
          react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      {
        rel: 'noreferrer',
        className: ThemeSwitcher_module_less_1.default.link,
        target: '_blank',
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        'div',
        { className: ThemeSwitcher_module_less_1.default.dropGroup },
        react_1.default.createElement(
          antd_1.Button,
          {
            type: 'link',
            className: ThemeSwitcher_module_less_1.default.switcher,
          },
          react_1.default.createElement(
            'div',
            { className: ThemeSwitcher_module_less_1.default.themeBtn },
            react_1.default.createElement(Colors, {
              colorStyle: {
        ...
        react_1.default.createElement(icons_1.CaretDownOutlined, {
          className: ThemeSwitcher_module_less_1.default.drop,
        }),
      ),
    ),
    curPalette &&
      react_1.default.createElement(
        'div',
        {
          className: ThemeSwitcher_module_less_1.default.palette,
          id: 'palette',
        },
        react_1.default.createElement(watermark_svg_1.default, null),
        react_1.default.createElement(
          'div',
          { className: ThemeSwitcher_module_less_1.default.bg },
          react_1.default.createElement(Colors, {
            colorStyle: {
